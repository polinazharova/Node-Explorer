  ...
  return (
    <div className="main__groups-list">
      ...
      <ul className="main__groups-list-ul">
          <li className="main__groups-list-item main__groups-list-item_selected" onClick={(event) => {handleGroupsItemClick(event, setSelectedGroup)}}>Все</li>
          {
            Object.keys(groups).map((id) => (
              <li className="main__groups-list-item" key={id} onClick={(event) => {handleGroupsItemClick(event, setSelectedGroup)}}>{groups[id]['groupName']}</li>
            ))
          }
      </ul>
    </div>
